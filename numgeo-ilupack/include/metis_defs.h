...
#define METIS_PERM_NONE 0
#define METIS_PERM_MMD  1
#define METIS_PERM_RCM  2
#define METIS_PERM_AMD  3
#define METIS_PERM_CAMD 4
...
/* #define ONMETIS_DBGLVL              (1+2+4+8+16+32+128) */
#define ONMETIS_OFLAGS		OFLAG_COMPRESS
#define ONMETIS_PFACTOR		-1
#define ONMETIS_NSEPS		1
#define ONMETIS_MSGLVL		0         /* 0: no ouput */
                                          /* 1: timing information (wallclock time) */
#define ONMETIS_EFACTOR         0.7       /* we assume that during the matching the */
#define ONMETIS_VFACTOR         0.7       /* number of vertices (and edges) are reduced */
                                          /* with this constant */
#define ONMETIS_THRESHSMALL     200
#define ONMETIS_TESTPERM        0
#define ONMETIS_RAND            0         /* 0: use original rand() function */
                                          /* else: use own rand() function */
/* #define ONMETIS_IND_TIMING */

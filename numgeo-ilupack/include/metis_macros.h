...
/* #define RandomInRange(u) ((1234567890>>3)%(u)) */
/* #define RandomInRangeFast(u) ((1234567890>>3)%(u)) */
#else
...
**************************************************************************/
#ifdef DMALLOC
#define imalloc(n, msg) (malloc(sizeof(integer)*(size_t)(n)))
#define fmalloc(n, msg) (malloc(sizeof(float)*(size_t)(n)))
#define idxmalloc(n, msg) (malloc(sizeof(idxtype)*(size_t)(n)))
#define ismalloc(n, val, msg) (iset((n), (val), malloc(sizeof(integer)*(size_t)(n))))
#define idxsmalloc(n, val, msg) (idxset((n), (val), malloc(sizeof(idxtype)*(size_t)(n))))
#define GKmalloc(a, b) (malloc((size_t)(a)))
#endif

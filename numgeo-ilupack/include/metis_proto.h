...
void METIS_EdgeND(integer *, idxtype *, idxtype *, integer *, integer *, idxtype *, idxtype *); 
void METIS_NodeND(integer *, idxtype *, idxtype *, integer *, integer *, idxtype *, idxtype *); 
void METIS_EdgeND_ord(integer *, idxtype *, idxtype *, integer *, integer *, idxtype *, 
		      idxtype *, integer, integer, float); 
void METIS_NodeND_ord(integer *, idxtype *, idxtype *, integer *, integer *, idxtype *,
                      idxtype *, integer, integer, float);
void METIS_NodeWND(integer *, idxtype *, idxtype *, idxtype *, integer *, integer *, idxtype *, idxtype *); 
...
void RCMOrder(CtrlType *, GraphType *, idxtype *, integer);
void AMDOrder(CtrlType *, GraphType *, idxtype *, integer);
void CAMDOrder(CtrlType *, GraphType *, idxtype *, integer);
integer metis_rcm_impl( integer n, integer* ia, integer* ja, integer *iperm );
void metis_quicksort_int_int(integer *a, integer *vec, integer l, integer r);
